...
*/
function Hamburger(bun, garnishes, cheeses, sauces, meat, patties, extras) {
    this.bun = bun;
    ...
    this.describe = function() {
        ...
        Patty : ${this.patties} ${this.meat} ,
        Bun: ${this.bun},
        Garnishes: ${this.garnishes.join(", ")},
        Cheese:  ${this.cheeses.join(", ")} ,
        Sauces: ${this.sauces.join(", ")},
        Toppings: ${this.extras.join(", ")}.`;
    }
}
...
output2.textContent = Burger.describe();
